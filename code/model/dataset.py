...
class SatelliteDataset(Dataset):
    ...
    def create_mask(self, lc_a, lc_b, lc_ab, binary_mask, rgb_b):
    ...
    def __getitem__(self, idx_a):
        ...
        for _ in range(num_inpaints):
            ...
            masked_area = self.create_mask(lc_a, lc_b, lc_ab, binary_mask, rgb_b)
     ...
     #   return rgb_a, lc_a, lc_b_mask, rgb_ab
        ...
        return rgb_a, rgb_b, lc_a, lc_b, binary_mask, lc_ab, masked_areas
